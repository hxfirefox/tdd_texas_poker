...
public class HighCardRuleTest {
    ...
    public void should_reorder_cards_in_round_by_descending() throws Exception {
        // given
        final Round round =
                new Round(new Card(A, 2), new Card(B, 10), new Card(C, 9), new Card(D, 3), new Card(B, 5));
        ...
        assertThat(sortedCards.get(3).equals(new Card(D, 3)), is(true));
        assertThat(sortedCards.get(4).equals(new Card(A, 2)), is(true));
    }
    ...
    public void should_return_winner_and_round_when_respective_round_has_different_greatest_face_value_() throws Exception {
        ...
        final Round playerRound =
                new Round(new Card(A, 3), new Card(B, 10), new Card(C, 9), new Card(D, 2), new Card(B, 5));
        final Round computerRound =
                new Round(new Card(A, 3), new Card(B, 13), new Card(C, 9), new Card(D, 2), new Card(B, 5));
        final HighCardRule rule = new HighCardRule();
        // when
    ...
    public void should_return_winner_and_round_when_respective_round_has_different_next_greatest_face_value_() throws Exception {
        // given
        final Round playerRound =
                new Round(new Card(A, 3), new Card(B, 10), new Card(C, 7), new Card(D, 2), new Card(B, 5));
        final Round computerRound =
                new Round(new Card(A, 3), new Card(B, 10), new Card(C, 9), new Card(D, 2), new Card(B, 5));
        final HighCardRule rule = new HighCardRule();
        // when
    ...
    public void should_return_draw_and_round_when_respective_round_has_same_face_value_() throws Exception {
        // given
        final Round playerRound =
                new Round(new Card(A, 3), new Card(C, 10), new Card(D, 9), new Card(A, 2), new Card(C, 5));
        final Round computerRound =
                new Round(new Card(A, 3), new Card(B, 10), new Card(C, 9), new Card(D, 2), new Card(B, 5));
        final HighCardRule rule = new HighCardRule();
        // when
